module.exports = {
    ...
    <body>
        ...
        while(i < instorages.length){
            ...
            if(instorages[i].storage === '보관함' || instorages[i].storage === '냉장고' || instorages[i].storage === '금고'){
                list = list + `<td><a style="text-decoration-line: none;" href="update/${instorages[i].id}">update</a>
